    ...
    if (//validar parametros
        validate) {
            ...
            switch (type) {
                case 1:
                    datosCon = {
                        ema_usu: paramsInsert.nom_usu,
                        new_ema_usu: paramsInsert.ema_usu
                    }
                    break;
                ...
                case 2:
                    ...
                    datosCon = {
                        ema_usu: paramsInsert.cod_eps,
                        new_ema_usu: paramsInsert.cod_per,
                        cla_usu: paramsInsert.cla_usu,
                        cla_usu: paramsInsert.cod_usu
                    }
                    break;
                ...
                case 3:
                    ...
                    datosCon = {
                        ema_usu: paramsInsert.ema_usu,
                        new_ema_usu: paramsInsert.cod_usu,
                        cla_usu: paramsInsert.cla_usu
                    }
                    break;
